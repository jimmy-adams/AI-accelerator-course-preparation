...
#
# Generated by Vivado on Sat Aug 21 16:15:05 CST 2021
...
xv_boost_lib_path=/home/jimmy/xilinx/Vivado/2020.1/tps/boost_1_64_0
xvhdl_opts="--relax"


# Script info
echo -e "c_addsub_0.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L c_reg_fd_v12_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_6 -L xbip_dsp48_addsub_v3_0_6 -L xbip_addsub_v3_0_6 -L c_addsub_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot c_addsub_0 xil_defaultlib.c_addsub_0 -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/jimmy/xilinx/Vivado/2020.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
